...
<div class="panel panel-default">
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-6">
                <h4 class="panel-title">Manage Contact Us Messages</h4>
            </div>
            <div class="col-md-6">
...
//                ),
                ...
                $html.= CHtml::checkBox('is_active', $data->is_active, array('class' => 'switchCls', 'contact_id' => $data->contact_id));
                $html.= '</div>';
                $html.= '</div>';
                return $html;
            },
