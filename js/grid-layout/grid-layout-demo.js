...
function downloadLayoutSrc() {
    ...
    t.find(".preview, .configuration, .drag, .remove").remove(), t.find(".lyrow").addClass("removeClean"), t.find(".box-element").addClass("removeClean"), t.find(".lyrow .lyrow .lyrow .lyrow .lyrow .removeClean").each(function() {
        ...
        cleanHtml(this)
    }), t.find(".removeClean,.ddlRights").remove(), $("#download-layout .column").removeClass("ui-sortable"), t.find(".column").removeClass("column"), $("#download-layout .container").length > 0 && changeStructure("row-fluid", "row"), formatSrc = $.htmlClean($("#download-layout").html(), {
        format: !0,
        allowedAttributes: [
            ["id"],
            ["class"],
    ...
    }), $("#download-layout").html(formatSrc), $(".downloadModal textarea").empty(), $(".downloadModal textarea").val(formatSrc),downloadLayout()
}
if (!function(t, e) {
    ...
    Z.fn = Z.prototype = {
        ...
        var t, e, i, n, s, o, a = arguments[0] || {}, r = 1,
                l = arguments.length,
                h = !1;
    ...
    var st = function(t) {
        ...
        return u.prototype = x.filters = x.pseudos, x.setFilters = new u, D = e.tokenize = function(t, i) {
            ...
            for (r = t, l = [], h = x.preFilter; r; ) {
                ...
                for (a in x.filter)
                    !(s = ft[a].exec(r)) || h[a] && !(s = h[a](s)) || (n = s.shift(), o.push({
                        value: n,
                        type: a,
                        matches: s
                    }), r = r.slice(n.length));
        ...
        add: function(t, e, i, n, s) {
            ...
            if (g)
                for (i.handler && (o = i, i = o.handler, s = o.selector), i.guid || (i.guid = Z.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function(e) {
                    ...
                    r = Et.exec(e[h]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p && (u = Z.event.special[p] || {}, p = (s ? u.delegateType : u.bindType) || p, u = Z.event.special[p] || {}, c = Z.extend({
                        type: p,
                        origType: m,
                        data: n,
                        handler: i,
    ...
    t(document).mouseup(function() {
        ...
        _animate: function(t, e, i) {
            var n, s, o, a = this,
                    ...
                    h = this.options.animate || {}, c = l && h.down || h,
                    u = function() {
                        a._toggleComplete(i)
                    };
    ...
    t.extend(s.prototype, {
        ...
        _create: function() {
            ...
            if (this.element.addClass("ui-resizable"), t.extend(this, {
                ...
                for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), e = this.handles.split(","), this.handles = {}, i = 0; e.length > i; i++)
                    n = t.trim(e[i]), o = "ui-resizable-" + n, s = t("<div class='ui-resizable-handle " + o + "'></div>"), s.css({
                        zIndex: r.zIndex
            ...
            var n = t(this).resizable("instance"),
                ...
                t(e).each(function() {
                    var e = t(this),
                            ...
                            o = {}, a = n && n.length ? n : e.parents(i.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
        ...
        drop: function(e, i) {
            //i.element.attr('sequence',drag+'_mitesh')
    ...
    function(t, e) {
        ...
        opacity: 1
        }, o[v] = 0, a.css("opacity", 0).css(v, b ? 2 * - d : 2 * d).animate(o, m, g)), h && (d /= Math.pow(2, p - 1)), o = {}, o[v] = 0, n = 0; p > n; n++)
            ...
            if (d && this.ready)
                for (i = d.length - 1; i >= 0; i--)
                    for (s = t(d[i]), n = s.length - 1; n >= 0; n--)
                        o = t.data(s[n], this.widgetFullName), o && o !== this && !o.options.disabled && (u.push([t.isFunction(o.options.items) ? o.options.items.call(o.element[0], e, {
                                item: this.currentItem
                            }) : t(o.options.items, o.element), o]), this.containers.push(o));
            for (i = u.length - 1; i >= 0; i--)
                for (a = u[i][1], r = u[i][0], n = 0, h = r.length; h > n; n++)
                    l = t(r[n]), l.data(this.widgetName + "-item", a), c.push({
                        item: l,
                        instance: a,
                        width: 0,
                        height: 0,
...
$(window).resize(function() {
    ...
    $("body").css("min-height", $(window).height() - 90), $(".demo").css("min-height", $(window).height() - 160), $(".demo, .demo .column").sortable({
        ...
        return $("body").removeClass("devpreview sourcepreview"),$('.ddlRights,.needToremove').show(), $("body").addClass("edit"), removeMenuClasses(), $(this).addClass("active"), !1
        ...
        return $("body").removeClass("edit"),$('.ddlRights,.needToremove').hide(), $("body").addClass("devpreview sourcepreview"), removeMenuClasses(), $(this).addClass("active"), !1
